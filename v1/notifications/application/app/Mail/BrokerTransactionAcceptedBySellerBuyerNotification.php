...
class BrokerTransactionAcceptedBySellerBuyerNotification extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->view('emails.broker.transaction_accepted_by_seller_to_buyer')
            ->subject($seller->email_address . ' has accepted the escrow transaction by.' . $sender->email_address . '.')->with($this->rdata);
    }
}
