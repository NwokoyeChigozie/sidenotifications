...
class MilestoneTransactionCompletedBuyerNotification extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        if (isset($this->payload->transaction->source) && $this->payload->transaction->source == 'instantescrow') {
            return $this->view('emails.instantescrow.milestone_completed_buyer')
