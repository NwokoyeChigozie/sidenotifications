...
class BrokerTransactionAcceptedByBuyerSellerNotification extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->view('emails.broker.transaction_accepted_by_buyer_to_seller')
            ->subject($buyer->email_address . ' has accepted the escrow transaction by.' . $sender->email_address . '.')->with($this->rdata);
    }
}
