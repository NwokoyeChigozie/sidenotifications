...
class BrokerTransactionRejectedByBuyerToBroker extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->view('emails.broker.transaction_rejected_by_buyer_to_broker')
            ->subject($buyer->email_address . ' has rejected your escrow transaction.')->with($this->rdata);
    }
}
