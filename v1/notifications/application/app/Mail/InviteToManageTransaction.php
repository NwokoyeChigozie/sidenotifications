...
class InviteToManageTransaction extends Mailable
{
    ...
    {
        return $this->view('emails.transactions.invite-to-manage-transaction')
            ->subject('You have been invited to Manage an Escrow Transaction ' . $this->transaction_id)
