...
class TransactionAcceptedBrokerNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        if (isset($this->payload->transaction->source)) {
            ...
            return (new MailMessage)
                ...
                ->view('emails.instantescrow.transaction_accepted_broker', [
                    'user' => $notifiable,
        ...
        if ($this->payload->transaction->parties->sender->account_id == $notifiable->account_id) {
            return (new MailMessage)
                ...
                ->view('emails.transactions.transaction_accepted_broker', [
                    'user' => $notifiable,
                    'payload' => $this->payload
                ]);
        }
