...
class BrokerTransactionAcceptedBySellerBrokerNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->view('emails.broker.transaction_accepted_by_seller_to_broker', [
                'user' => $notifiable,
