...
class BrokerTransactionRejectedBySellerToBuyer extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject($seller->email_address . ' has rejected the escrow transaction by ' . $sender->email_address . '.')
            ->view('emails.broker.transaction_rejected_by_seller_to_buyer', [
                'user' => $notifiable,
