...
$dotenv  = Dotenv::create(dirname(dirname(dirname(dirname(dirname(__FILE__)))))); // Dir where your .env file is located
$dotenv  = $dotenv->load();
...
$app->middleware([
    \App\Http\Middleware\BannedIp::class,
