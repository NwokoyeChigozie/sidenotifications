...
<body style="background-color: #222533; padding: 20px; font-size: 14px; line-height: 1.43; font-family: &quot;Helvetica Neue&quot;, &quot;Segoe UI&quot;, Helvetica, Arial, sans-serif;">
    ...
    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
        ...
        <div style="padding: 20px 10px; border-top: 1px solid rgba(0,0,0,0.05);">
            <div style="color: #636363; font-size: 16px;">

                <p>Hello {{ $payload->buyer->firstname ?? $payload->buyer->email_address }}, </p>

                <p>Unfortunately, the transaction ({{ $payload->transaction->title }}) was not accepted by {{ $payload->seller->email_address }}. Please discuss with them to make sure the terms of the transaction are correct. </p>
