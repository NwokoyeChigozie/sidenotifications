    ...
    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
        ...
        <div style="padding: 20px 10px; border-top: 1px solid rgba(0,0,0,0.05);">
            <div style="color: #636363; font-size: 16px;">
                ...
                <p>Unfortunately, the transaction ({{ $payload->transaction->title }}) was not accepted by {{ $payload->buyer->email_address }}. Please discuss with them to make sure the terms of the transaction are correct. </p>
