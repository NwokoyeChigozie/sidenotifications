...
<div style="color: #636363; font-size: 16px; line-height: 24px;">
    ...
    <p style="margin-bottom: 20px;">
        You can view and manage your transaction by visiting your <a href="{{ env('SITE_URL') }}/login?customer-phone={{ $payload->buyer->phone_number ?? '' }}&customer-email={{ $payload->buyer->email_address ?? '' }}">dashboard</a>
    </p>
