...
<div style="color: #636363; font-size: 14px;">
    ...
    <p>
    Your transaction ({{ $payload->transaction->transaction_id ?? '' }}) has been successfully created and sent to {{ $payload->buyer->email_address ?? '' }} and {{ $payload->seller->email_address ?? '' }}. You will be notified once they accept the transaction.
    </p>
