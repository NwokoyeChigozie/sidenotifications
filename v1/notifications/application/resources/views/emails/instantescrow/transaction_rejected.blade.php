        ...
        <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
            ...
            <div style="padding: 20px 0px; border-top: 1px solid rgba(0,0,0,0.05);">
                <div style="color: #636363; font-size: 14px;">
                    ...
                    <p>Unfortunately, your transaction ({{ $payload->transaction->transaction_id }}) was not accepted by {{ $payload->seller->email_address }}. Please discuss with them to make sure the terms of the transaction are correct. To create another transaction with updated terms, visit <a href="https://instant.vesicash.com">https://instant.vesicash.com</a></p>
