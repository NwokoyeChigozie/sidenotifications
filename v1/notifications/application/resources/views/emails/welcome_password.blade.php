    ...
    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
        ...
        <div style="padding: 20px 0px; border-top: 1px solid rgba(0,0,0,0.05);">
            ...
            <div style="color: #636363; font-size: 14px;">
                <p>
                    You need a password to access your Vesicash account. Click on the link below using the secure token generated for you to set your password.
                </p>
            </div>
            <div style="color: #636363; font-size: 14px;">
                <p>
                    Your secure token is <b>{{ $payload->token }}</b>
                </p>
                <p>
                    <b>Code expires in 48 hours</b>
                </p>
            </div>
            <a href="{{ env('APP_URL') }}/reset-password/{{ $user->account_id }}" style="padding: 8px 20px; background-color: #3BB75E; color: #fff; font-weight: bolder; font-size: 16px; display: inline-block; margin: 20px 0px; margin-right: 20px; text-decoration: none;">Create Password</a>
