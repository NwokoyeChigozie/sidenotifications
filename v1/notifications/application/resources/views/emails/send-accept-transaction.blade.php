...
<div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
    ...
    <div style="padding: 20px 0px; border-top: 1px solid rgba(0,0,0,0.05);">
        <h1 style="margin-top: 0px;">Hi user</h1>
        <div style="color: #636363; font-size: 14px;">
            <p>
                The escrow transaction “{{ $payload->transaction->title ?? null }}" is still awaiting your approval.
                Login to your dashboard to review the terms and accept it so that the escrow process can commence.
                Our system automatically deletes pending transactions when they’re not acted upon.
                Regards.
            </p>
        </div>
