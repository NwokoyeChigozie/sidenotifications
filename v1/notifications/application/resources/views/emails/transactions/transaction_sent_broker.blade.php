...
<div style="color: #636363; font-size: 14px;">
    ...
    <!-- <p>
        Your transaction ({{ $payload->transaction->transaction_id ?? '' }}) has been successfully created and sent to {{ $payload->buyer->full_name ?? $payload->buyer->email_address }} and {{ $payload->seller->full_name ?? $payload->seller->email_address }} for review and acceptance.
    </p> -->
