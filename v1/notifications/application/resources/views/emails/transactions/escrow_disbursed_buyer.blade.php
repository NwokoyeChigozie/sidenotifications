        ...
        <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
            ...
            <div style="padding: 20px 0px; border-top: 1px solid rgba(0,0,0,0.05);">
                <div style="color: #636363; font-size: 14px;">
                    <p style="margin-top: 0px;">Dear {{ $payload->buyer->firstname ?? $payload->buyer->email_address  }},</p>

                    <p>
                        Funds for transaction "{{ $payload->transaction->title ?? $payload->transaction->transaction_id }}" has now been disbursed to <Strong>{{ $payload->seller->firstname ?? $payload->seller->email_address }}</Strong>.
                        <br> Thank you for choosing vesicash!
                    </p>
