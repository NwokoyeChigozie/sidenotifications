    ...
    <body style="background-color: #222533; padding: 20px; font-family: font-size: 14px; line-height: 1.43; font-family: &quot;Helvetica Neue&quot;, &quot;Segoe UI&quot;, Helvetica, Arial, sans-serif;">
        ...
        <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
            ...
            <div style="padding: 20px 0px; border-top: 1px solid rgba(0,0,0,0.05);">
                <h4 style="margin-top: 0px;">Dear {{ $payload->seller->firstname ?? $payload->seller->email_address }},</h4>
                <div style="color: #636363; font-size: 14px;">
                    <p>
                        You are expected to deliver order "{{$payload->transaction->title ?? $payload->transaction->transaction_id}}" to {{ $payload->buyer->firstname ?? $payload->buyer->email_address }}. If you have done this, kindly click this <a href="{{ $payload->business->website ?? env('SITE_URL') }}">link</a> to confirm delivery so that you can both proceed to the next phase of the transaction.
                    </p>
                    <p>
