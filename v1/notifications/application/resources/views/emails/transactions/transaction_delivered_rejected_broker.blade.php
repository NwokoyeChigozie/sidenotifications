...
<body style="background-color: #222533; padding: 20px; font-family: font-size: 14px; line-height: 1.43; font-family: &quot;Helvetica Neue&quot;, &quot;Segoe UI&quot;, Helvetica, Arial, sans-serif;">
    ...
    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
        ...
        <div style="padding: 20px 15px; border-top: 1px solid rgba(0,0,0,0.05);">
            <div style="color: #636363; font-size: 16px;">

                <p>Hello, {{ $payload->broker->firstname ?? $payload->broker->email_address }}, </p>

                <p>The buyer ({{ $payload->buyer->firstname ?? $payload->buyer->email_address }}) has rejected this order by the seller ({{ $payload->seller->email_address }}). Find details of the transaction below.</p>

                @include('emails.transactions.transaction_table')

                <p>Kindly reach out to the seller to ascertain the cause of the failed transaction.</p>
