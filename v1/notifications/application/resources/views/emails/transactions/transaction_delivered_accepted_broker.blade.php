    ...
    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
        ...
        <div style="padding: 20px 15px; border-top: 1px solid rgba(0,0,0,0.05);">
            <div style="color: #636363; font-size: 16px;">
                ...
                <p>The buyer ({{ $payload->buyer->firstname ?? $payload->buyer->email_address }}) has accepted this order by the seller ({{ $payload->seller->email_address }}). Find details of the transaction below.</p>
        ...
        <div style="background-color: #F5F5F5; padding: 40px; text-align: center;">
            <div style="color: #A5A5A5; font-size: 12px; margin-bottom: 20px; padding: 0px 30px;">
