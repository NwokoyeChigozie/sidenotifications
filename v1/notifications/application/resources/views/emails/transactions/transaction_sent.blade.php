...
<div style="color: #636363; font-size: 14px;">
    ...
    <p>
    Your transaction ({{ $payload->transaction->transaction_id ?? '' }}) has been successfully created and sent {{ $payload->recipient->full_name ?? $payload->recipient->email_address }} for review and acceptance.
    </p>
    ...
    <p>
        You will be notified when the other party(ies) involved accepts this transaction. <br> With Vesicash, you can always pay with confidence…
    </p>
    <p>
