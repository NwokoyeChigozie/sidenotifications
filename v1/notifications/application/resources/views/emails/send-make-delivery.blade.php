...
<div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
    ...
    <div style="padding: 20px 0px; border-top: 1px solid rgba(0,0,0,0.05);">
        <h1 style="margin-top: 0px;">Hello user</h1>
        <div style="color: #636363; font-size: 14px;">
            <p>
                Have you delivered the escrow transaction “{{ $payload->transaction->title }}" ?.
                Login to your dashboard and click on “Delivered” to notify the escrow to release your funds in time.
                Failure to do this could cause the other party to dispute the transaction which could cause the funds not to be released.
                Regards,
            </p>
            <p>
