        ...
        <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
            ...
            <div style="padding: 20px 0px; border-top: 1px solid rgba(0,0,0,0.05);">
                ...
                <div style="color: #636363; font-size: 14px;">
                    ...
                    <div>
                        <div>
                            <a style="background: green; padding: 10px; color: white; text-align: center; text-decoration: none; display:block; padding-bottom: 5px; margin-bottom: 5px;" href="{{ env('SITE_URL') }}/login?customer-phone={{ $payload->recipient->phone_number ?? '' }}&customer-email={{ $payload->recipient->email_address ?? '' }}">Accept Escrow Transaction</a>

                            <a style="background: red; padding: 10px; color: white; text-align: center; text-decoration: none; display:block;" href="{{ env('SITE_URL') }}/login?customer-phone={{ $payload->recipient->phone_number ?? '' }}&customer-email={{ $payload->recipient->email_address ?? '' }}">Reject this transaction</a>
                        </div>
                    </div>
                </div>
                <p>
