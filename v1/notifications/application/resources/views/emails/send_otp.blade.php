...
<div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
    <table style="width: 100%;">
        <tr>
            <td style="background-color: #fff;">
                {{-- @if(!is_null($payload->business->logo_uri))
                <img alt="Vesicash" src="{{ $payload->business->logo_uri ?? 'https://i.ibb.co/qRywKpr/Webp-net-resizeimage.png' }}">
            @else --}}
                <img alt="Vesicash" src="https://i.ibb.co/qRywKpr/Webp-net-resizeimage.png">
            {{-- @endif --}}
            </td>
    ...
    <div style="padding: 20px 0px; border-top: 1px solid rgba(0,0,0,0.05);">
        <h4 style="margin-top: 0px;">Hi {{ $user->email_address}},</h4>
        <div style="color: #636363; font-size: 14px;">
            <p>
                Kindly copy and paste this code in the column for OTP on your browser to proceed with your {{ $this->payload->business->business_name ?? 'Vesicash' }}’s verification.

                For further questions, kindly visit our FAQ page <a href="https://vesicash.com/faq">https://vesicash.com/faq</a> or send an email to support@vesicash.com
                </p>
            <p>
                Your One-Time Password (OTP) is: {{ $otp_token }}.
            </p>
        </div>
        <!-- <a href="https://vesicash.com/login" style="padding: 8px 20px; background-color: #3BB75E; color: #fff; font-weight: bolder; font-size: 16px; display: inline-block; margin: 20px 0px; margin-right: 20px; text-decoration: none;">Enter OTP</a> -->
    </div>
