...
<div style="color: #636363; font-size: 14px;">
    ...
    <p>
    Your transaction ({{ $payload->transaction->title ?? $payload->transaction->transaction_id }}) has been successfully created and sent to {{ $payload->buyer->email_address ?? $payload->buyer->firstname }} and {{ $payload->seller->email_address ?? $payload->seller->firstname }} for review and acceptance.
    </p>
